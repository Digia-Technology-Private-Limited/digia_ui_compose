...
//                    )
//
//            status = DigiaUIStatus.Ready(digiaUI, viewModel)
...
//                    viewModel = currentStatus.viewModel,
//                    analytics = analytics,
...
//     */
//    data class Ready(val digiaUI: DigiaUI, val viewModel: DigiaUIViewModel) : DigiaUIStatus() {
//        val isLoading = false
//        val isReady = true
//        val hasError = false
//    }
